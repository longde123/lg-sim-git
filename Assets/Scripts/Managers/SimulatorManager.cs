...
public class SimulatorManager : MonoBehaviour
{
    ...
    public ScenarioManager ScenarioManagerPrefab;
    ...
    public ScenarioManager Scenario {get; private set; }
    ...
    private int m_use_case_id = 0;
    private int m_scenario_id = 0;
    private int m_test_case_id = 0;
    ...
    public void Init(int? seed = null)
    {
        ...
        if(IsAPI)
        {
            Scenario = Instantiate(ScenarioManagerPrefab, ManagerHolder.transform);
        }
    ...
    {
        Scenario.ScenarioRunner(m_use_case_id,m_scenario_id,m_test_case_id);
    }
    public ArrayList GetScenarioResults()
    {
        return Scenario.GetResults();
    }
    public void Scenario_Config(int use_case_id, int scenario_id, int test_case_id)
    {
    ...
    {
        Scenario.SetRouteDestination(position, distance, speed);
    }
