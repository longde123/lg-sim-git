...
namespace Simulator.Map
{
    public class MapManagerData
    {
        ...
        public List<MapLine> GetTrafficLeftBoundaryLines()
        {
            var lanes = GetTrafficLanes();
            var allMapLines = new List<MapLine>();
            foreach(var lane in lanes)
            {
                allMapLines.Add(lane.leftLineBoundry);
            }
            return allMapLines;
        }

        public List<MapLine> GetTrafficRightBoundaryLines()
        {
            var lanes = GetTrafficLanes();
            var allMapLines = new List<MapLine>();
            foreach(var lane in lanes)
            {
                allMapLines.Add(lane.rightLineBoundry);
            }
            return allMapLines;
        }
