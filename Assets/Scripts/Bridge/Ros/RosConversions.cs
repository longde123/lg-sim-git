...
namespace Simulator.Bridge.Ros
{
    static class Conversions
    {
        ...
        public static Snowball.CompressedImage ConvertFromRos2(ImageData data)
        {
            return new Snowball.CompressedImage()
            {
        ...
        public static Snowball.tfMessage ConvertFrom(StaticTFData data)
        {
            return new Snowball.tfMessage() {
                transforms = new [] {
                    new Snowball.TransformStamped()
                    {
                        header = new Snowball.Header()
                        {
                            stamp = new Snowball.Time(data.Time),  
                        ...
                        transform = new Snowball.Transform() {
                            translation = ConvertToVector(data.translation),
                            rotation = Convert(data.rotation),
                        }
                    }
                }
            };
		...
		// public static Snowball.DetectedObjectArray ConvertFrom(Detected3DObjectDataPerc data)
        // {
        //     return new Snowball.DetectedObjectArray()
        //     {
        //         header = new Snowball.Header()
        //         {
        //             stamp = new Snowball.Time(data.Time),
        //             frame_id = data.Frame,
        //         },
        //         objects = data.objects.Select(d => new Snowball.DetectedObject()
        //         {
        //             header = new Snowball.Header()
        //             {
        //                 stamp = new Snowball.Time(data.Time),
        ...
        //             score = (float)d.Score,
        //             valid = true,
        //             yaw = -d.Rotation.eulerAngles.y,
        //             space_frame = "",
        //             pose = new Pose()
        //             {
        //                 position = new Point{x = d.easting, y = d.northing, z = 0.0},
        //                 orientation = Convert(d.Rotation),
        //             },
        //             dimensions = ConvertToVector(d.Scale),
        ...
        //                 angular = ConvertToVector(d.AngularVelocity),
        //             },
        //             acceleration = new Twist(),
        //             pointcloud = new Snowball.PointCloud2(),                   
        //             pose_reliable = true,
        ...
        //             y_pos = d.northing,
        //             z_pos = 0.0,
        //             length_dim = d.Scale[0],
        //             width_dim = d.Scale[1],
        //             height_dim = d.Scale[2],
        //             image_frame = "",
        //             x = 0,
        //             y = 0,
        //             width = 0,
		...
		// 			indicator_state = 0,
        //             behavior_state = 0,
        //             user_defined_info = new string[] {},
        //         }).ToList(),
		// 		frame = new Image(),
        //     };
        // }

    public static Snowball.ObstacleArray ConvertFrom(Detected3DObjectDataPerc data)
        {
            return new Snowball.ObstacleArray()
            {
                header = new Snowball.Header()
                {
                    stamp = new Snowball.Time(data.Time),
                ...
                obstacles = data.objects.Select(d => new Snowball.Obstacle()
                {
                    header = new Snowball.Header()
                    {
                        stamp = new Snowball.Time(data.Time),
        ...
        public static Snowball.TrackedObjectArray ConvertFrom(Detected3DObjectDataAdhoc data)
        {
            return new Snowball.TrackedObjectArray()
            {
                header = new Snowball.Header()
                {
                    stamp = new Snowball.Time(data.Time),
                ...
                objects = data.objects.Select(d => new Snowball.TrackedObject()
                {
                    track_id = d.Id,
                    obj_class = d.Label,
                    exist_conf = (float)d.Score,
                    class_conf = (float)d.Score,
                    pose = new Pose()
                    {
                        position = new Point{x = d.easting, y = d.northing, z = 0},
                        orientation = Convert(d.Rotation),
                    },
                    size = ConvertToVector(d.Scale),
                    vel = new Twist()
        ...
        public static Snowball.TrafficLightData ConvertFrom(SignalDataAdhoc data)
        {
            byte varia = 0;
            switch (data.label)
                {
            ...
            return new Snowball.TrafficLightData()
            {
                header = new Snowball.Header()
                {
                    stamp = new Snowball.Time(data.Time),
                ...
                trafficlight_id = data.id,
                trafficlight_roi = new Snowball.RegionOfInterest(){
                    x_offset = data.xoff,
                    y_offset = data.yoff,
                    height = data.height,
                    width = data.width,
        ...
        public static Snowball.ChassisDataMsg ConvertFrom(ChassisData data)
        {
            return new Snowball.ChassisDataMsg()
            {
                header = new Snowball.Header()
                {
                    stamp = new Snowball.Time(data.stamp),
                    frame_id = data.frame_id
                },
                steering_torque = data.steering_torque,
                ...
                cruise_start = data.cruise_start,     
                cruise_cancel = data.cruise_cancel,    
        ...
        public static Snowball.novatelInsPVA ConvertFrom(novatelInsPvaData data)
        {
            return new Snowball.novatelInsPVA()
            {
                header = new Snowball.Header()
                {
                    stamp = new Snowball.Time(data.stamp),
        ...
        public static Snowball.novatelRawImuX ConvertFrom(novatelRawImuXData data)
        {
            return new Snowball.novatelRawImuX()
            {
                header = new Snowball.Header()
                {
                    stamp = new Snowball.Time(data.stamp),
                ...
                y_accel_neg = data.y_accel_neg,
                x_accel = data.x_accel,
                z_gyro = data.z_gyro,
                y_gyro_neg = data.y_gyro_neg,
                x_gyro = data.x_gyro
            };
        }

        public static Snowball.novatelMarkCount ConvertFrom(novatelMarkCountData data)
        {
            return new Snowball.novatelMarkCount()
            {
                header = new Snowball.Header()
                {
                    stamp = new Snowball.Time(data.stamp),
                ...
                mark_num = data.mark_num,
                period = data.period,
                count = data.count,
            };
        }

        public static Snowball.novatelBestPos ConvertFrom(novatelBestPosData data)
        {
            return new Snowball.novatelBestPos()
            {
                header = new Snowball.Header()
                {
                    stamp = new Snowball.Time(data.stamp),
                ...
                sol_status_str = data.sol_status_str,
                pos_type = data.pos_type,
                pos_type_str = data.pos_type_str,
                lat = data.lat,
                lon = data.lon,
                hgt = data.hgt,
                undulation = data.undulation,
                datum_id = data.datum_id,
                lat_std_dev = data.lat_std_dev,
                lon_std_dev = data.lon_std_dev,
                hgt_std_dev = data.hgt_std_dev,
                std_id = data.std_id,
                diff_age = data.diff_age,
                sol_age = data.sol_age,
                num_svs = data.num_svs,
                num_sol_in_svs = data.num_sol_in_svs,
                num_sol_in_l1_svs = data.num_sol_in_l1_svs,
                num_sol_in_multi_svs = data.num_sol_in_multi_svs,
                ext_sol_stat = data.ext_sol_stat,
                galileo_beidou_sig_mask = data.galileo_beidou_sig_mask,
                gps_glonass_sig_mask = data.gps_glonass_sig_mask,
            };
        }
        public static Snowball.novatelCorrIMU ConvertFrom(novatelCorrIMUData data)
        {
            return new Snowball.novatelCorrIMU()
            {
                header = new Snowball.Header()
                {
                    stamp = new Snowball.Time(data.stamp),
                ...
                vertical_acc=data.vertical_acc,
            };
        }

        public static Snowball.novatelHeading ConvertFrom(novatelHeadingData data)
        {
            return new Snowball.novatelHeading()
            {
                header = new Snowball.Header()
                {
                    stamp = new Snowball.Time(data.stamp),
                ...
                pitch=data.pitch,
                heading_std_dev=data.heading_std_dev,
                pitch_std_dev=data.pitch_std_dev,
                station_id=data.station_id,
                num_svs=data.num_svs,
                num_sol_in_svs=data.num_sol_in_svs,
                num_obs=data.num_obs,
                num_multi=data.num_multi,
        ...
        public static SnowballControlData ConvertTo(Snowball.ControlData data)
        {
            return new SnowballControlData()
            {
